...
class TestGenerationTask(TestCase):
    ...
    def test_bpa_latest(self):
        self.run_test('BPA', self.latest_kwargs)

    def test_caiso_latest(self):
        self.run_test('CAISO', self.latest_kwargs)

    def test_caiso_forecast(self):
        self.run_test('CAISO', self.forecast_kwargs)

    def test_ercot_latest(self):
        self.run_test('ERCOT', self.latest_kwargs)

    def test_isone_latest(self):
        self.run_test('ISONE', self.latest_kwargs)

    def test_miso_latest(self):
        self.run_test('MISO', self.latest_kwargs)

    def test_pjm_latest(self):
        self.run_test('PJM', self.latest_kwargs)

    def test_sveri_latest(self):
        self.run_test('AZPS', self.latest_kwargs)
...
class TestLoadTask(TestCase):
    ...
    def test_isone_forecast(self):
        self.run_test('ISONE', self.forecast_kwargs)

    def test_pjm_latest(self):
        self.run_test('PJM', self.latest_kwargs)

    def test_pjm_forecast(self):
        self.run_test('PJM', self.forecast_kwargs)

    def test_ercot_latest(self):
        self.run_test('ERCOT', self.latest_kwargs)

    def test_ercot_forecast(self):
        self.run_test('ERCOT', self.forecast_kwargs)

    def test_nyiso_latest(self):
        self.run_test('NYISO', self.latest_kwargs)

    def test_nyiso_forecast(self):
        self.run_test('NYISO', self.forecast_kwargs)
...
class TestTradeTask(TestCase):
    ...
    def test_miso_forecast(self):
        self.run_test('MISO', self.forecast_kwargs)
